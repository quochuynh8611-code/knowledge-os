...
export const INITIAL_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    type: "dong-y",
    parentId: null,
    description: "Lĩnh vực nghiên cứu Đông y — Lý luận cơ bản, Tạng tượng, Bát cương, Dược học và Kinh lạc châm cứu.",
    icon: "Layers",
    color: "#059669",
  },
  {
    ...
    type: "ngon-ngu",
    parentId: null,
    description: "Lĩnh vực nghiên cứu và học tập ngôn ngữ — Chữ Hán cổ, Ngữ pháp Pāli, Sanskrit và Thuật ngữ học thuật.",
    icon: "Globe",
    color: "#0284C7",
  },
  ...
  // Đông Y (Lý luận & Dược học)
  {
    id: "cat-ly-luan-dong-y",
    name: "Lý Luận Cơ Bản",
    slug: "ly-luan-co-ban",
    type: "dong-y",
    parentId: "cat-root-dong-y",
    description: "Học thuyết Âm Dương, Ngũ Hành, Tạng Tượng, Khí Huyết Tân Dịch và Bát Cương biện chứng.",
    icon: "Layers",
    color: "#059669",
  },
  {
    id: "cat-duoc-hoc-dong-y",
    name: "Dược Học Cổ Truyền",
    slug: "duoc-hoc-co-truyen",
    type: "dong-y",
    parentId: "cat-root-dong-y",
    description: "Tính năng dược vật: Tứ khí, Ngũ vị, Thăng giáng phù trầm, Quy kinh và Bát trận phối ngũ.",
    icon: "Sparkles",
    color: "#10B981",
  },

  // Học Ngôn Ngữ (Hán Cổ, Pāli & Sanskrit)
  {
    id: "cat-tieng-han-co",
    name: "Chữ Hán Cổ",
    slug: "chu-han-co",
    type: "ngon-ngu",
    parentId: "cat-root-ngon-ngu",
    description: "Lục thư, 214 Bộ thủ, Cấu trúc ngữ pháp Hán văn cổ và Văn ngôn kinh điển.",
    icon: "BookOpen",
    color: "#0284C7",
  },
  {
    id: "cat-tieng-pali-sanskrit",
    name: "Pāli & Phạn Ngữ (Sanskrit)",
    slug: "pali-sanskrit",
    type: "ngon-ngu",
    parentId: "cat-root-ngon-ngu",
    description: "Mẫu tự Devanāgarī, Ngữ pháp Pāli / Sanskrit căn bản, Biến cách danh từ và Động từ căn.",
    icon: "Globe",
    color: "#0EA5E9",
  },
];
...
- **Bố Cục Trạch Bàn Vận 9**: Ưu tiên phương Nam có ánh sáng, phương Bắc có thủy tụ sinh khí để đắc vượng tài đinh.`,
  ...
  // Đông Y Starter Topics (Dormant-by-default)
  {
    id: "top-dongy-1",
    title: "Âm Dương Ngũ Hành & Học Thuyết Tạng Tượng",
    slug: "am-duong-ngu-hanh-tang-tuong",
    categoryId: "cat-ly-luan-dong-y",
    type: "dong-y",
    description:
      "Học thuyết cơ sở nền tảng của Y học phương Đông khảo sát mối tương quan Âm Dương, Ngũ Hành và chức năng tạng phủ.",
    content: "## 1. Học Thuyết Âm Dương\nÂm Dương đối lập, hỗ căn, tiêu trưởng và bình hành.\n\n## 2. Học Thuyết Tạng Tượng\nNăm tạng (Can, Tâm, Tỳ, Phế, Thận) tàng tinh khí và Sáu phủ truyền hóa vật chất.",
    tags: [],
    links: [],
    visibility: "active",
  ...
  {
    id: "top-dongy-2",
    title: "Tứ Khí Ngũ Vị & Bát Cương Biện Chứng",
    slug: "tu-khi-ngu-vi-bat-cuong",
    categoryId: "cat-duoc-hoc-dong-y",
    type: "dong-y",
    description:
      "Quy luật dược tính (Hàn, Nhiệt, Ôn, Lương / Tân, Cam, Toan, Khổ, Hàm) và phương pháp biện chứng chẩn trị 8 cương lĩnh.",
    content: "## 1. Tứ Khí Ngũ Vị\nTính chất và mùi vị của dược thảo y học cổ truyền.\n\n## 2. Bát Cương Biện Chứng\nÂm - Dương, Biểu - Lý, Hàn - Nhiệt, Hư - Thực trong chẩn đoán y học.",
    tags: [],
    links: [],
    visibility: "active",
  ...
  // Học Ngôn Ngữ Starter Topics (Dormant-by-default)
  {
    id: "top-ngonngu-1",
    title: "214 Bộ Thủ Chữ Hán & Phương Pháp Chiết Tự",
    slug: "214-bo-thu-chu-han-chiet-tu",
    categoryId: "cat-tieng-han-co",
    type: "ngon-ngu",
    description:
      "Hệ thống 214 bộ thủ Khang Hy, quy tắc bút thuận, kết cấu hình - thanh - hội ý và kỹ thuật phân tích tự dạng Hán cổ.",
    content: "## 1. Hệ Thống 214 Bộ Thủ\nKhảo cứu các bộ thủ cơ bản biểu nghĩa và biểu âm trong văn tự Hán.\n\n## 2. Lục Thư Chiết Tự\nTượng hình, Chỉ sự, Hội ý, Hình thanh, Chuyển chú, Giả tá.",
    tags: [],
    links: [],
    visibility: "active",
  ...
  {
    id: "top-ngonngu-2",
    title: "Bảng Chữ Cái Devanāgarī & Hệ Thống Ngữ Âm Phạn-Pāli",
    slug: "devanagari-ngu-am-phan-pali",
    categoryId: "cat-tieng-pali-sanskrit",
    type: "ngon-ngu",
    description:
      "Nguyên âm, phụ âm, quy tắc chuyển tự La-tinh (IAST) và phát âm chuẩn các thuật ngữ Phạn - Pāli kinh điển.",
    content: "## 1. Mẫu Tự Devanāgarī & IAST\nNguyên âm ngắn/dài, phụ âm cổ họng, vòm miệng, uốn lưỡi, răng và môi.\n\n## 2. Quy Tắc Biến Âm (Sandhi)\nCác quy luật kết hợp ngữ âm căn bản trong văn bản Pāli / Sanskrit.",
    tags: [],
    links: [],
    visibility: "active",
